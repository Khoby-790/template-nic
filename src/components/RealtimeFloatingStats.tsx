...
const RealtimeFloatingStats = (props: Props) => {
    ...
    if (!showDetails) {
        return (
            <div onClick={() => setShowDetails(true)} className="absolute animate-bounce group bottom-10 w-auto  right-6 shadow-xl rounded-lg p-2 bg-yellow-300">
    ...
    return (
        <Fragment>
            <div className="lg:absolute fixed lg:bottom-10 bottom-2 lg:w-6/12 w-full lg:right-6 right-0 shadow-xl rounded-lg bg-gray-800">
