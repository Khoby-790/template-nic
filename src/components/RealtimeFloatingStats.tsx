...
const RealtimeFloatingStats = (props: Props) => {
    ...
    if (!showDetails) {
        return (
            <div onClick={() => setShowDetails(true)} className="absolute lg:animate-bounce group lg:bottom-10 bottom-0 w-auto  lg:right-6 shadow-xl rounded-lg p-2 bg-yellow-300">
    ...
    return (
        <Fragment>
            <div className="fixed lg:bottom-10 bottom-0 lg:w-6/12 w-full h-screen lg:right-6 shadow-xl lg:rounded-lg rounded-none bg-gray-800">
