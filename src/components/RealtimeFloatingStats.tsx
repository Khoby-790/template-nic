...
const RealtimeFloatingStats = (props: Props) => {
    ...
    if (!showDetails) {
        return (
            <div onClick={() => setShowDetails(true)} className="absolute group bottom-10 w-auto  right-6 shadow-xl rounded-lg p-2 bg-yellow-300">
                <svg className="h-6 animate-ping group-hover:animate-none" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
