...
const RealtimeFloatingStats = (props: Props) => {
    ...
    if (!showDetails) {
        return (
            <div onClick={() => setShowDetails(true)} className="absolute lg:animate-bounce group lg:bottom-10 bottom-0 w-auto  right-6 shadow-xl rounded-lg p-2 bg-yellow-300">
