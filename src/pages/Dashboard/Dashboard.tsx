            ...
            <div className="flex space-x-3">
                ...
                <div className="flex-1 space-y-1">
                    <div className="flex items-center justify-between">
                        <h3 className="text-md font-medium">Whitney Francis</h3>
                        <p className="text-md text-gray-500">1h</p>
                    </div>
                    <p className="text-md text-gray-500">Deployed Workcation (2d89f0c8 in master) to production</p>
                </div>
            </div>
        </li>
    )
