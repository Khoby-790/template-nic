...
const Option = ({ name }: OptionProps) => {
    return (
        <div className="flex-1 h-16 flex group flex-row hover:bg-gray-500 hover:border-blue-200 hover:shadow-md cursor-pointer hover:-translate-y-1 transform transition bg-gray-50  my-3 rounded-md border border-blue-50">
