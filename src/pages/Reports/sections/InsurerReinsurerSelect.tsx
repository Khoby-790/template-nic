...
const Option = ({ name }: OptionProps) => {
    return (
        <div className="flex-1 h-16 flex group flex-row hover:bg-gray-500 hover:border-blue-200 hover:shadow-md cursor-pointer hover:-translate-y-1 transform transition bg-gray-50 mx-5 my-3 rounded-md border border-blue-50">
            <div className="h-full flex flex-row flex-1">
                ...
                <div className="flex items-center h-full">
                    <span className="font-semibold text-xl transform transition group-hover:text-white text-gray-400">{name || "Not Specified"}</span>
                </div>
            </div>
