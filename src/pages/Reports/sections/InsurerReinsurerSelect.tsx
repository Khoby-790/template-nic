...
const Option = () => {
    return (
        <div className="flex-1 hover:bg-blue-200 hover:border-blue-200 cursor-pointer hover:translate-y-2 transform transition bg-gray-50 mx-5 py-4 my-3 rounded-md border border-blue-50">
