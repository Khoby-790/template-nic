...
const Option = ({ name }: OptionProps) => {
    return (
        <div className="flex-1 h-16 flex group flex-row hover:bg-blue-200 hover:border-blue-200 hover:shadow-md cursor-pointer hover:-translate-y-1 transform transition bg-gray-50 mx-5 my-3 rounded-md border border-blue-50">
            <div className="h-full flex flex-row flex-1">
                <div className="flex w-20 items-center justify-center h-full group-hover:text-white">
